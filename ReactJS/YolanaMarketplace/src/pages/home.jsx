...
import { NftObject, Dropdown, Slider, Button, Loader } from 'components';
  ...
  return (
    <div>
      <section
        ...
        style={{
          backgroundImage: `url(${require('../assets/images/bg-shape-1-dark.jpg')})`,
        }}>
        <Slider onBtnClick={executeScroll} />
      </section>
